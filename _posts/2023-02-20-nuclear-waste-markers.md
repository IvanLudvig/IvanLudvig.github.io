...
<li> Basic Information: Tells what, why, when, where, who, and how
    <center>
...
- Obnoxious materials: bad smell that is enclosed into glass capsules that break when stressed; or materials with a low-level radioactivity.

Considered examples of the architecure include:

A Spike Field: the concrete spikes suggest danger to the body like thorns, spikes and lightning.
<center>
